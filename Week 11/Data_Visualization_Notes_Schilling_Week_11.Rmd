...
This section is not in the book as is taken from [Time Based Heatmaps in R](https://www.littlemissdata.com/blog/heatmaps). `geom_tile()` can be used to create heat maps.
